    ...
    try:
        ...
        for t in recent_times:
            ...
            if date_str in records_by_date:
                records_by_date[date_str]["thetao_degC"] = float(
                    subset_sst.sel(time=t).mean().values
                )
        ...
        for t in recent_times:
            ...
            if date_str in records_by_date:
                ...
                records_by_date[date_str]["uo_velocity_m_s"] = float(
                    daily_slice["uo"].mean().values
                )
                records_by_date[date_str]["vo_velocity_m_s"] = float(
                    daily_slice["vo"].mean().values
                )
